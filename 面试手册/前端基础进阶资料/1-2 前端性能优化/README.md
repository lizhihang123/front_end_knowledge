...
![image-20190619100048897](./assets/image-20190619100048897.png)
...
![image-20190618165435861](./assets/image-20190618165435861.png)
...
3. **渲染引擎（Rendering engine）** - 负责显示请求的内容。如果请求的内容是 HTML，它就负责解析 HTML 和 CSS 内容，并将解析后的内容显示在屏幕上。
   ...
   ![image-20190618172835156](./assets/image-20190618172835156.png)
...
5. 异步http请求线程
   ...
   ![image-20190619165952240](./assets/image-20190619165952240.png)
...
![DOM CSSOM RenderTree](./assets/render-tree-construction.png)
...
![img](./assets/webkitflow.png)



我们可以使用调试工具来看一个真实的例子：

![image-20190618182337662](./assets/image-20190618182337662.png)
...
![browser-rendering](./assets/browser-rendering.gif)

![backend-generation](./assets/backend-generation.gif)



![wpo-front-backend](./assets/wpo-front-backend.png)
...
![image-20190619145105413](./assets/image-20190619145105413.png)
...
![image-20190618210408261](./assets/image-20190618210408261.png)

点击`Login with Github to Create Test Cases`:

![image-20190619103010414](./assets/image-20190619103010414.png)

登录之后，进入授权页面：

![image-20190619103140822](./assets/image-20190619103140822.png)

登录过后，就可以创建自己的测试用例啦：

![image-20190619143549467](./assets/image-20190619143549467.png)
...
![screencapture-jsperf-2019-06-18-21_15_29](./assets/screencapture-jsperf-2019-06-18-21_15_29.png)



测试过程：

![image-20190618211820471](./assets/image-20190618211820471.png)



测试结果：

![image-20190618211915799](./assets/image-20190618211915799.png)

这里有一个更全面的对比结果：

https://jsperf.com/for-vs-foreach/75

![image-20190618213130251](./assets/image-20190618213130251.png)

![image-20190618213201840](./assets/image-20190618213201840.png)

还有一些比较有意思的测试：

可以通过浏览：[https://jsperf.com/popular](https://jsperf.com/popular)进行查看

![image-20190619143653346](./assets/image-20190619143653346.png)
...
![image-20190619212956061](./assets/image-20190619212956061.png)

#### 使用Chrome插件/Mozila插件

![image-20190619203556941](./assets/image-20190619203556941.png)
...
![image-20190619212836235](./assets/image-20190619212836235.png)
...
![DOM Rendering](./assets/63503acbly1fk2te7tuh0j20nv0dbjtl.jpg)
...
![img](./assets/63503acbly1fk56dzdbn9j20nr068dga.jpg)
...
![img](./assets/63503acbly1fk56e0sokqj20oj074ab1.jpg)
...
![img](./assets/63503acbly1fk56e15x4jj20ny082mxu.jpg)
